...
// don't delete this, start work with this
public class Main {
    ...
    static Roster openRosterFile() throws IOException {
        ...
        // added
        String parent = "C:\\Users\\rapha\\IdeaProjects\\java_practice\\src\\VerdeValleyVolleyball\\";

        return new Roster(parent + fileName);
    }
